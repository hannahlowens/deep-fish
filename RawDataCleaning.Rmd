...
First, I read in the data, do some preliminary name cleaning, and see what we're working with.
...
# Using raw search results because iDigBio processed data doesn't include latitude or longitude
...
# Remove lines with no depth information whatsoever
fishData <- fishData %>%
